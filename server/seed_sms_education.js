...
const educations = [
    { title: '12월 정기 안전 보건 교육', type: '정기', instructor: '김철수 안전팀장', place: '현장 안전교육장', content: '동절기 한랭질환 예방 및 미끄러짐 사고 방지 대책', date: '2023-12-01', attendees: 18 },
    { title: '신규 채용자 안전 교육', type: '신규채용', instructor: '박영희 안전관리자', place: '관리 사무실 회의실', content: '현장 기본 안전 수칙, 보호구 착용법', date: '2023-12-03', attendees: 8 },
    { title: '밀폐 공간 작업 특별 안전 교육', type: '특별', instructor: '외부 초빙 강사', place: '지하 2층 펌프실 앞', content: '산소 농도 측정 방법, 송기 마스크 착용 실습', date: '2023-11-28', attendees: 12 },
    { title: '콘크리트 타설 작업 안전 교육', type: '특별', instructor: '최오반 공사과장', place: '101동 1층 로비', content: '펌프카 전도 방지, 타설 시 추락 주의', date: '2023-11-25', attendees: 15 },
...
async function seedEducations() {
    ...
    try {
        console.log('Seeding Education Data with Attendees...');
        ...
        for (const edu of educations) {
            ...
            for (let i = 0; i < edu.attendees; i++) {
                ...
                await client.query(`
                    INSERT INTO sms_education_attendees (education_id, worker_name, worker_birth, worker_agency, signature_url)
                    VALUES ($1, $2, $3, $4, $5)
                `, [educationId, randomName, randomBirth, randomAgency, 'Signed']);
            }
        }

        await client.query('COMMIT');
        console.log('Successfully seeded 5 Education records with realistic attendees.');
    } catch (err) {
