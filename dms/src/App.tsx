...
import ProjectRegisterModal from './components/ProjectRegisterModal' // Import Modal
...
function App() {
  ...
  const [isProjectRegisterOpen, setIsProjectRegisterOpen] = useState(false)
        ...
        <div className="app-shell">
          <header className="topbar">
            ...
            <div className="header-actions">
              ...
              <button
                onClick={() => setIsProjectRegisterOpen(true)}
                style={{
                  display: 'flex',
                  alignItems: 'center',
                  justifyContent: 'center',
                  ...
                  color: 'white',
                  border: 'none',
                  padding: '0.42rem 0.8rem', // Match .auth-pill padding
                  borderRadius: '8px',       // Match .auth-pill radius approx
                  cursor: 'pointer',
                  fontSize: '0.9rem',
                  fontWeight: 600,
                  marginRight: '0.5rem',
                  height: '36px',            // Enforce height to match pills
                  boxSizing: 'border-box'
                }}
              >
          ...
          <ProjectRegisterModal
            isOpen={isProjectRegisterOpen}
            onClose={() => setIsProjectRegisterOpen(false)}
            onSuccess={() => {/* Maybe refresh dashboard? For now just close */ }}
          />
        </div>
      </ProjectProvider>
    </ToastProvider>
